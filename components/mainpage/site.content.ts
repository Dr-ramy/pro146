...
}, 
{
  ...
  blocks: [
    { type: "subheading", text: " مهارات تخطيط الدرس	" },
    {
      type: "bullets",
      items: [
    ...
    { type: "divider" },
    { type: "subheading", text: "مهارات تنفيذ الدرس" },
    {
      type: "bullets",
      items: [
        "عرض الدرس",
    ...
    { type: "divider" },
    { type: "subheading", text: "إعداد الدروس تكنولوجيًا" },
    {
      type: "bullets",
      items: [
